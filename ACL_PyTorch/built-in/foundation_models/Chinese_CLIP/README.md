...
1. 模型转换。
   ...
   3. 使用 opt_onnx.py 优化 onnx 模型。
      ...
      # export bs=16
      python3 opt_img_onnx.py models/vit-b-16.img.fp16.bs${bs}.sim.onnx models/vit-b-16.img.fp16.bs${bs}.opt.onnx vit_base_patch16_224
      ```
   ...
   3. 使用ATC工具将ONNX模型转OM模型。
      ...
      3. 执行ATC命令。
         ```shell
         # 例如 export bs=1 && export chip_name=310P3
         atc --framework=5 \
...
2. 开始推理验证。
   ...
   2. 精度验证。
      ...
      运行成功后打印om推理结果与onnx推理结果的余弦相似度，确保精度正常。
