...
3. 安装昇腾推理工具
   ...
   请访问[msit代码仓](https://gitcode.com/ascend/msit/tree/master/msit/)，根据readme文档进行工具安装。可只安装需要的组件：debug surgeon，其他组件为可选安装。
...
| 模型              | BatchSize | 300I Pro性能（默认） | 300I Pro性能（优化1）| 300I Pro性能（优化2）|
| :---------------: | :-------: | :--------------: | :--------------: | :--------------: |
