...
1. 模型转换。
   ...
   2. 导出onnx文件。
      ...
      2. 使用convert.py和fix_onnx.py脚本对onnx模型进行优化(按照链接安装auto-optimizer[[auto-optimizer链接](https://gitcode.com/ascend/msadvisor/tree/master/auto-optimizer)])
         ```
...
2. 开始推理验证。
   ...
   1. 安装msit推理工具。
      ...
      请访问[msit推理工具](https://gitcode.com/ascend/msit.git)代码仓，根据readme文档进行工具安装。
