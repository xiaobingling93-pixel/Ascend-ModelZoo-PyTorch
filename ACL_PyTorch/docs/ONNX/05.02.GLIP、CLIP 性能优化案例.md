...
具体请参考 [GLIP 推理指导流程](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/built-in/cv/GLIP_STATIC)。
...
具体请参考 [Chinise-CLIP 推理指导流程](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/built-in/foundation_models/Chinese_CLIP)。
