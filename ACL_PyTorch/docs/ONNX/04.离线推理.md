...
ais_bench命令更详细的用法请参考其[Gitcode主页](https://gitee.com/ascend/tools/tree/master/ais-bench_workload/tool/ais_bench)。
...
| 任务类别 | 离线推理案例 |
| --------- | -------------- |
| 图像分类 | [Resnet50](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/built-in/cv/Resnet50_Pytorch_Infer) |
| 目标检测 | [YoloX_Tiny](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/built-in/cv/YoloX_Tiny_for_Pytorch) |
| 语音识别 | [Deepspeech2](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/contrib/audio/Deepspeech2) |
| OCR | [StarNet_MobileNetV3](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/contrib/nlp/StarNet_MobileNetV3) |
| 自然语言理解 | [Bert_Base](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/built-in/nlp/Bert_Base_Uncased_for_Pytorch) |
...
| 任务类别 | 离线推理案例 |
| --------- | -------------- |
| 语音处理 | [Conformer](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/built-in/audio/Conformer_for_Pytorch) |
| 文生图 | [Stable Diffusion](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/built-in/foundation_models/stable_diffusion) |
