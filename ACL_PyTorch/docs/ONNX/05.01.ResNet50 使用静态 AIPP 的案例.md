...
具体请参考 [ResNet50 推理指导](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/ACL_PyTorch/built-in/cv/Resnet50_Pytorch_Infer)。
...
| ---- | ---- | ---- | ---- | ---- | ---- |
| 接入 AIPP 前的 ResNet50 | ImageNet 验证集 50000 张图片 | 300I Pro | 64 | Top1 75.37%<br>Top2 85.49%<br>Top3 89.24%<br>Top4 91.27%<br>Top5 92.52% | 2630 fps |
| 接入 AIPP 后的 ResNet50 | ImageNet 验证集 50000 张图片 | 300I Pro | 64 | Top1 75.37%<br>Top2 85.48%<br>Top3 89.23%<br>Top4 91.27%<br>Top5 92.51% | 2929 fps |
