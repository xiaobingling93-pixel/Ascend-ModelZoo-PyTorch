...
1. 模型在 300I PRO 设备上的性能是 T4 设备上性能的 0.677 倍，已通过性能评审。
2. 模型在 300I PRO 设备上的精度优于开源仓提供的精度，高出 0.17 个百分点。

指标详情如下：

| 模型名 | batchsize | 300I PRO实测精度 | 开源仓精度 |T4性能 | 300I PRO性能 | 300I PRO/T4 |
|-------| --------- | -------- | --------- | -------- | ---- | ---- |
