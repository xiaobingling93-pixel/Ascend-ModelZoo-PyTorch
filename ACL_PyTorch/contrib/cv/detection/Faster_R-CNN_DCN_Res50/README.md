...
1. 模型转换。
   ...
   2. pth导出onnx文件。
      ...
      1. 生成onnx模型。
         ...
         调用mmdetection/tools目录中的pytorch2onnx脚本生成onnx模型。这里注意指定shape为1216。当前框架限制，仅支持batchsize=1的场景。

         ```
         python3.7 mmdetection/tools/pytorch2onnx.py mmdetection/configs/dcn/faster_rcnn_r50_fpn_dconv_c3-c5_1x_coco.py mmdetection/checkpoints/faster_rcnn_r50_fpn_dconv_c3-c5_1x_coco_20200130-d68aed1e.pth   --output-file faster_rcnn_r50_fpn_1x_coco.onnx  --shape 1216
         ```
...
| batch_size | 官网pth精度  | 基准性能 | 300I Pro精度    | 300I Pro性能 | A500 A2精度    | A500 A2性能 |
| :----------: | :----------: | :----------: | :----------: | :----------: | :----------: | :----------: |
| 1          | box AP:41.3% | 5.40FPS  | box AP:41.1% | 8.00FPS  | box AP:41.1% | 2.84      |
