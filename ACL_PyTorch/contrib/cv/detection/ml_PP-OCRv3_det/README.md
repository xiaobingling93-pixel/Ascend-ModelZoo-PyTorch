...
- 在300I Pro设备上对OM模型进行实验，各batch_size推理结果与PaddleOCR在线推理推理结果一致，由此判断精度达标；当batchsize为1时，模型性能最佳，达349.6fps。

    | 芯片型号   | Batch Size | 数据集  | 精度          | 性能        |
    | --------- | ---------- | ------- | ------------- | ---------- |
    |300I Pro| 1          | 样例图片 | 与在线推理一致 | 349.6 fps  |
    |300I Pro| 4          | 样例图片 | 与在线推理一致 | 339.1 fps  |
    |300I Pro| 8          | 样例图片 | 与在线推理一致 | 321.4 fps  |
    |300I Pro| 16         | 样例图片 | 与在线推理一致 | 323.2 fps  |
    |300I Pro| 32         | 样例图片 | 与在线推理一致 | 320.9 fps  |
    |300I Pro| 64         | 样例图片 | 与在线推理一致 | 286.8 fps  |
