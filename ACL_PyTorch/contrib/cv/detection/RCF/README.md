...
1. 模型转换。
   ...
   2. 导出onnx文件。
      ...
      2. 优化ONNX文件。
           安装auto-optimizer工具。请访问[auto-optimizer改图工具](https://gitcode.com/ascend/msadvisor/tree/master/auto-optimizer)代码仓，根据readme文档进行工具安装。
...
| --------- | ---------------- | ------------ | ---------- | --------------- |
|   300I Pro   |        1         |   BSDS500    |   ODS：0.798，OIS：0.817   |      93.76      |