...
1. 获取原始数据集。（解压命令参考tar –xvf  \*.tar与 unzip \*.zip）
   ...
   本模型支持OTB2015约60000张图片的测试集。请用户从[开源仓](https://github.com/HonglinChu/SiamTrackers)自行获取OTB2015数据集，上传数据集到服务器任意目录并解压（如：/home/HwHiAiUser）。本模型将使用到OTB2015数据集上的100个测试序列，并计算Success_score和Precision_score。 目录结构如下：
