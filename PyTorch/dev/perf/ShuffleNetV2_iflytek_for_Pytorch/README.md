...
- 三方库依赖如下表所示。
  ...
  **表 2**  三方库依赖表
  ...
  |:--------------------------------:| :----------------------------------------------------------: |
  |  PyTorch 2.1  | pillow==9.5.0, torchvision==0.16.0 |
...
| 1p-NPU |   -   | 2015.75  |    90    |   FP32    |     1.11      |
| 8p-NPU |  62.714   | 10611.4  |    90   |    FP32     |     1.11      |
| 1p-NPU |   -   |  2081.3  |    90    |   FP32    |      2.1      |
| 8p-NPU |   62.714   | 10502.56 |    90    |    FP32     |      2.1      |

说明：上表为历史数据，仅供参考。2025年5月10日更新的性能数据如下：
| NAME | 精度类型 | FPS |
| :------ |:-------:|:------:|
| 8p-竞品 | FP32 | 10502.56 |
| 8p-Atlas 900 A2 PoDc | FP32 | 14524.82 |
