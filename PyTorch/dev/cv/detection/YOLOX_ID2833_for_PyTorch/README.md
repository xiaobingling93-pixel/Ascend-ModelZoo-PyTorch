...
- 当前模型支持的固件与驱动、 CANN 以及 PyTorch 如下表所示。
  ...
  **表 1**  版本配套表
  ...
  | 配套        | 版本                                                         |
  | ---------- | ------------------------------------------------------------ |
  | 固件与驱动   | [24.1.RC2](https://www.hiascend.com/hardware/firmware-drivers?tag=commercial) |
  | CANN       | [8.0.RC2](https://www.hiascend.com/zh/developer/download/commercial/result?module=cann) |
  | PyTorch    | [2.1.0](https://gitee.com/ascend/pytorch/tree/master/)|
  | mxDriving | [6.0.0-RC2](https://gitee.com/ascend/mxDriving)|
