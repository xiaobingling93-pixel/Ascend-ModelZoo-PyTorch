...
| 1p-NPU | - |  646.97  |     1     |     O1     |     1.11      |
| 8p-NPU | 0.4289  | 2950.817 |   280     |    O1     |     1.11      |
| 1p-NPU | - | 644.608  |     1     |     O1     |      2.1      |
| 8p-NPU | 0.4289  | 3005.633 |    280    |     O1     |      2.1      |
...
**说明1：** 以上精度结果为执行train_full_8p.sh脚本所得的验证集的结果。

说明2：上表为历史数据，仅供参考。2024年12月31日更新的性能数据如下：
| NAME | 精度类型 | FPS |
| :------ |:-------:|:------:|
| 8p-竞品 | FP16 | 3005.633 |
| 8p-Atlas 900 A2 PoDc | FP16 | 4336.99 |
