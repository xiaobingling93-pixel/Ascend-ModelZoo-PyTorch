...
2. 运行训练脚本。
   ...
   - 单机单卡训练
     ...
     bash ./test/train_performance_1p.sh --data_path=real_data_path --data_shuffle=False  # 单卡性能
   ...
   - 单机8卡训练
     ...
     bash ./test/train_performance_8p.sh --data_path=real_data_path --data_shuffle=False  # 8卡性能
     ```
