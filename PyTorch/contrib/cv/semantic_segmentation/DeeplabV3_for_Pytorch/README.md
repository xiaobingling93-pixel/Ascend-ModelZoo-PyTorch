...
1. 获取数据集。
   ...
   请用户自行下载**cityscapes**数据集，在源码包根目录下新建文件夹data，并将cityscapes数据集放于data目录下。
...
| :-----: | :---: |:-------:|:-------:| :------: | :------: |:-------------:|
| 1p-NPU | -    | -     | 14.806  | 1000      |       O2 |     1.11      |
| 8p-NPU | 96.13 | 78.98 | 115.593 | 7000 |       O2 |     1.11      |

说明：上表为历史数据，仅供参考。2025年5月10日更新的性能数据如下：
| NAME | 精度类型 | FPS |
| :------ |:-------:|:------:|
| 8p-竞品 | FP16 | 115.593 |
| 8p-Atlas 900 A2 PoDc | FP16 | 138.92 |
