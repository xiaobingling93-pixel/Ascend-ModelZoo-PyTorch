...
1. 获取数据集。
   ...
   下载 `LibirSpeech` 数据集，包括 `train-clean-100`，`dev-clean`，按照 [wav2vec2.0](https://github.com/facebookresearch/fairseq/tree/main/examples/wav2vec) 准备 `manifest`，统一放置到 `$data_path` 目录下。
   数据集目录结构参考如下所示。
    ```
    $data_path
    ├── train-clean-100
...
| 1p-NPU | - | 7641.03 |   -    |    -     |     1.11      |
| 8p-NPU |  5.546 | 66513.6 |   -    |    -     |     1.11      |
| 1p-NPU | - | 7373.43 |   -    |    -     |      2.1      |
| 8p-NPU |  5.546 | 66346.9 |   -    |    -     |      2.1      |

说明：上表为历史数据，仅供参考。2024年12月31日更新的性能数据如下：
| NAME | 精度类型 | FPS |
| :------ |:-------:|:------:|
| 8p-竞品 | FP32 | 44493.3 |
| 8p-Atlas 900 A2 PoDc | FP32 | 78111.7 |
