...
### 安装模型环境
  ...
  **表 1**  三方库版本支持表
  ...
  |        三方库        |      支持版本      |
  |:-----------------:|:--------------:|
  |      PyTorch      |  2.1.0, 2.2.0 , 2.3.1 |
  |    TorchVision    | 0.16.0, 0.17.0 , 0.18.1 |
  |       NumPy       |     1.23.5     |
...
|----------|:--:|:------:|:------:|:------:|:------:|:------:|:------:|:------:|:----------:|:--------:|:-------------:|
| GPU      | 8p | 0.3245 | 0.6546 | 0.2712 | 0.5572 | 0.8833 | 0.2288 | 0.4027 |     64     |   fp16   |      2.1      |
| Atlas A2 | 8p | 0.3247 | 0.6555 | 0.2716 | 0.5251 | 0.8661 | 0.2316 | 0.4073 |     64     |   fp16   |      2.1      |

##### 性能

| 芯片       | 卡数 | FPS  | Each epoch time  | batch_size | AMP_Type | Torch_Version | 
|----------|:--:|:----:|:----:|:----:|:--------:|:-------------:|
| GPU      | 8p |  56  |  0.65 h  | 64 |   fp16   |      2.1      |
| Atlas A2 | 8p | 45 |   0.81 h  | 64|  fp16    |      2.1      |
