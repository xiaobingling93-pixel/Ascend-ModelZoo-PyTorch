...
by @torch.jit.export (see asr_model.py),
which are required and used in C++ runtime in torch_asr_model.cc.
...
Please see encoder.py:forward_chunk() and torch_asr_model.cc for details of the caches.
