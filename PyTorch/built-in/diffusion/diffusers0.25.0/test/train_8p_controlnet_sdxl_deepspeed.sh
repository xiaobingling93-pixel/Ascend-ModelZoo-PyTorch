...
accelerate launch --config_file ./test/lora_controlnet_accelerate_deepspeed_config.yaml ./examples/controlnet/train_controlnet_sdxl.py \
 ...
 --validation_image "./controlnet_image/conditioning_image_1.png" "./controlnet_image/conditioning_image_2.png" \
