...
- 适配昇腾 AI 处理器的实现：
  ...
  ```
  url=https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/PyTorch/built-in/foundation/GPT-NeoX
...
2. 安装deepspeed_npu插件
  ...
  ```
  # adaptor分支
  git clone https://gitcode.com/ascend/DeepSpeed.git
  cd Deepspeed
  pip install ./
  ```
3. 安装pdsh插件
...
|:-------------:|:-------------:|:-:|:-:|:-:|:----:|
| GPU-2pp4mp2dp |     100      | 5000   | fp16  | 1.5  | 竞品A |
| NPU-2pp4mp2dp |     150      | 5000   | fp16  | 1.5  | NPU |
