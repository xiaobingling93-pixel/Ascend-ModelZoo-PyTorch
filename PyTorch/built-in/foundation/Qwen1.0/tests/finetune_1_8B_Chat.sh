...
MODEL="/your/path/Qwen-1_8B-Chat" # Set the path if you do not want to load from huggingface directly
...
torchrun $DISTRIBUTED_ARGS finetune.py \
    ...
    --deepspeed ./ds_config_zero2.json > ./output/finetune_1_8B_Chat.log 2>&1 &
wait
