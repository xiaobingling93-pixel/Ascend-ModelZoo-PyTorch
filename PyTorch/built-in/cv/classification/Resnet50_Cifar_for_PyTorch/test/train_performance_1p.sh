...
nohup taskset -c 0-31 python3 ./tools/train.py ./configs/resnet/resnet50_8xb256_cifar100_perf.py --cfg-options data.samples_per_gpu=256 > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
