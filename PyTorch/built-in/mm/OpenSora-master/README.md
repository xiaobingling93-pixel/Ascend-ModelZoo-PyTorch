...
**注意**： 本仓库OpenSora-master模型将不再进行维护，请使用[MindSpeed-MM](https://gitcode.com/ascend/MindSpeed-MM/tree/master/examples/opensora1.2)
...
> 注：OpenSora主线从此目录演进，包含OpenSora1.1和OpenSora1.2，OpenSora1.0单独维护，见 [PyTorch/built-in/mlm/OpenSora1.0 · Ascend/ModelZoo-PyTorch - 码云 - 开源中国 (gitcode.com)](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/PyTorch/built-in/mlm/OpenSora1.0)


> <span style="color: red;">**注意**: OpenSora-master目录下面的OpenSora1.2模型已经集成到[MindSpeed-MM](https://gitcode.com/ascend/MindSpeed-MM)中,当前目录下的OpenSora1.2模型不再维护，MindSpeed-MM是面向大规模分布式训练的昇腾多模态大模型套件，同时支持多模态生成及多模态理解,欢迎大家使用。</span>
## 支持任务列表
