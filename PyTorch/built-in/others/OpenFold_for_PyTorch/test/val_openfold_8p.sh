...
python3 train_openfold.py  $data_path/pdb_data/mmcif_files \
                           ...
                           ./output \
                           "2021-10-10" \
                           --train_chaintrain_mmcif_data_cache_path $data_path/pdb_data/data_caches/chain_data_cache.json \
...
val_loss=$(tac openfold_val_8p.log | grep -m1 'val/loss' | sed -n 's/.*val\/loss[[:space:]]\+\([0-9.]\+\).*/\1/p')
