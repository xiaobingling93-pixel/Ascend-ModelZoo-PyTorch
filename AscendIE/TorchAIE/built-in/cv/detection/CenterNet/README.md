...
1. 执行推理。
    ...
    python CenterNet_inference.py                                            \
        --aie-module-path ./CenterNet_torchscriptb${batch_size}_torch_aie.pt \
        --batch-size ${batch_size}                                           \
...
| ---------- | -------- | ---- | ------- |
| 1          | COCO2017 | 36.6 | 29.60 fps |
| 4          | COCO2017 | 36.6 | 29.60 fps |
| 8          | COCO2017 | 36.6 | 29.14 fps |
| 16         | COCO2017 | 36.6 | 29.39 fps |
| 32         | COCO2017 | 36.6 | 29.48 fps |
|  |  | **最优性能** | **29.60** |
