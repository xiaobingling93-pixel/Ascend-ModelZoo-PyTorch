...
class CoreAttention(torch.nn.Module):
    ...
    def scaled_dot_product_attention(self, query, key, value, temp_seqlen, attn_mask=None, dropout_p=0.0, is_causal=False, scale=None):
    ...
    def generate(
        ...
        **kwargs,
        ...
        if is_greedy_gen_mode:
            ...
            raise ValueError(
                    f"other generate function is in processing!"
                )
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        if return_dict_in_generate:
            raise ValueError("return dict is not support.")
        else:
            return input_ids
