...
def load_vad_model(model_dir, device, ts_model_path, vad_onset=0.500, vad_offset=0.363):
    ...
    vad_pipeline = VoiceActivitySegmentation(segmentation=vad_model, device=torch.device(device), ts_model_path=ts_model_path)
...
class VoiceActivitySegmentation(VoiceActivityDetection):
    def __init__(
        ...
        **inference_kwargs,
        ...
        super().__init__(segmentation=segmentation, fscore=fscore, use_auth_token=use_auth_token, ts_model_path=ts_model_path, **inference_kwargs)
