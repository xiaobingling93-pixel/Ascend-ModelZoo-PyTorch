...
3. 安装auto_optimizer
    ...
    参考[链接](https://gitcode.com/ascend/msadvisor/tree/master/auto-optimizer)中的说明进行安装
...
6. 导出ts模型
   ...
   请查看代码仓[Conformer模型-推理指导](https://gitcode.com/ascend/ModelZoo-PyTorch/tree/master/MindIE/MindIE-Torch/built-in/audio/Conformer)的README.md将ONNX模型转换为ts模型。
