...
def compile_img_encode(model, inputs, image_encode_compiled_path, soc_version):
    compiled_image_encode_model = (
        mindietorch.compile(model,
                            inputs=inputs,
                            allow_tensor_replace_int=True,
                            require_full_compilation=True,
    ...
    torch.jit.save(compiled_image_encode_model, image_encode_compiled_path)