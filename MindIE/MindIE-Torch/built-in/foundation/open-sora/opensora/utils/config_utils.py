...
def parse_args(training=False):
    ...
    parser.add_argument("--vae_path", type=str, help="path to vae model; will overwrite cfg.vae_path if specified")
    parser.add_argument("--t5_path", type=str, help="path to t5 model; will overwrite cfg.t5_path if specified")
    parser.add_argument("--batch-size", default=None, type=int, help="batch size")
    parser.add_argument("--use_mindie", default=0, type=int, help="1 is use mindie; 0 is use cpu")
    parser.add_argument("--device_id", default=0, type=int, help="npu device id")
    parser.add_argument("--output_dir", type=str, default="./models", help="compiled models path")
