...
class AIEStableDiffusionXLPipeline(StableDiffusionXLPipeline):
    ...
    def compile_aie_model(self):
        ...
        clip1_compiled_path = os.path.join(self.args.output_dir, f"clip/clip_bs{size}_aie_compile.ts")
        ...
        clip2_compiled_path = os.path.join(self.args.output_dir, f"clip/clip2_bs{size}_aie_compile.ts")
        if os.path.exists(clip2_compiled_path):
            self.compiled_clip_model_2 = torch.jit.load(clip2_compiled_path).eval()
        else:
            model = torch.jit.load(os.path.join(self.args.output_dir, f"clip/clip2_bs{size}.pt")).eval()
