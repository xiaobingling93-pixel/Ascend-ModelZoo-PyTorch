...
- [Qwen3-1.7B](https://www.modelscope.cn/models/Qwen/Qwen3-1.7B/files)
...
目前提供的MindIE镜像预置了Qwen3-1.7B模型推理脚本，无需再额外下载魔乐仓库承载的模型适配代码，直接新建容器即可。
...
...
"modelName" : "qwen3",
"modelWeightPath" : "/data/datasets/Qwen3-1.7B",
"worldSize" : 2,
...
}
]
