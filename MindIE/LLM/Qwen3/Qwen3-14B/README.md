...
docker run -it -d --net=host --shm-size=1g \
    ...
    mindie:2.2.T10-800I-A2-py3.11-openeuler24.03-lts-aarch64 bash
```
...
>
> 2. 设定容器名称`--name`与镜像名称，例如800I A2服务器使用`mindie:2.2.T10-800I-A2-py3.11-openeuler24.03-lts-aarch64`。
>
> 3. 设定想要使用的卡号`--device`。
>
