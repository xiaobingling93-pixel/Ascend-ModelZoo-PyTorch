...
- [Qwen3-4B-Base](https://www.modelscope.cn/models/Qwen/Qwen3-4B-Base/files)
...
目前提供的MindIE镜像预置了Qwen3-4B-Base模型推理脚本，无需再额外下载魔乐仓库承载的模型适配代码，直接新建容器即可。
...
...
"modelName" : "qwen3",
"modelWeightPath" : "/data/datasets/Qwen3-4B-Base",
"worldSize" : 2,
...
}
]
