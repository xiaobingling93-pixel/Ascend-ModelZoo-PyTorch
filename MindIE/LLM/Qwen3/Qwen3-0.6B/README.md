...
- [Qwen3-0.6B](https://www.modelscope.cn/models/Qwen/Qwen3-0.6B/files)
...
目前提供的MindIE镜像预置了Qwen3-0.6B模型推理脚本，无需再额外下载魔乐仓库承载的模型适配代码，直接新建容器即可。
...
...
"modelName" : "qwen3",
"modelWeightPath" : "/data/datasets/Qwen3-0.6B",
"worldSize" : 2,
...
}
]
