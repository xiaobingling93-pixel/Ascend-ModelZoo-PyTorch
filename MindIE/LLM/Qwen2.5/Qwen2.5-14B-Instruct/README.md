...
- 部署Qwen2.5-14B-Instruct模型至少需要1台Atlas 800I A2服务器或者1台配置一张Atlas 300I DUO推理卡的服务器。
...
样例 -BoolQ
```
bash run.sh pa_bf16 full_BoolQ 1 qwen ${Qwen2.5-14B-Instruct权重路径} 8
```

样例 -CEval
```
bash run.sh pa_bf16 full_CEval 5 1 qwen ${Qwen2.5-14B-Instruct权重路径} 8
```
...
样例：
```
bash run.sh pa_bf16 performance [[256,256]] 1 qwen ${Qwen2.5-14B-Instruct权重路径} 8
```
            ...
            "ModelConfig" : [
                {
                    ...
                    "modelName" : "qwen",
                    "modelWeightPath" : "/home/data/qwen2.5-14B-Instruct",
                    "worldSize" : 8,
                    "cpuMemSize" : 5,
                    "npuMemSize" : -1,
                    "backendType" : "atb",
