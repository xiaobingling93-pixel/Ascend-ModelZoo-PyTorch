# DeepSeek-R1-Distill-Qwen-1.5B-OrangePi
...
### 魔乐社区下载量化权重(推荐)
**量化权重下载**
- [DeepSeek-R1-Distill-Qwen-1.5B-W8A8-OrangePi](https://modelers.cn/models/MindIE/DeepSeek-R1-Distill-Qwen-1.5B-OrangePi/tree/main/deepseek-qwen-1.5B-w8a8)
### 本地部署w8a8量化
...
# DeepSeek-R1-Distill-Qwen-1.5B量化，无回退层，antioutlier使用m1算法配置，使用min-max量化方式，校准数据集使用50条BoolQ数据，在NPU上进行运算
