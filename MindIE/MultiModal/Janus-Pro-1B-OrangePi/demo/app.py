...
# Multimodal Understanding function
def multimodal_understanding(input_image, question_input, seed_val, top_p_val, temperature_val):
    ...
    pil_images = [Image.fromarray(input_image)]
    ...
    outputs = vl_gpt.language_model.generate(
        ...
        max_new_tokens=512,
        do_sample=False if temperature_val == 0 else True,
        use_cache=True,
