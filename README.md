...
| [MindIE](https://gitee.com/ascend/ModelZoo-PyTorch/tree/master/MindIE) | 基于昇腾芯片的推理引擎模型参考 |

# 如何贡献

本仓子模块参考目录，可以直接克隆子仓，也可以克隆主仓，在开始贡献之前，请先阅读[NOTICE](https://gitee.com/ascend/modelzoo/blob/master/CONTRIBUTING.md)，谢谢！
